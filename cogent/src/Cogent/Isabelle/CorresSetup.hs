...
locale thy cfile =
  ...
  , "definition"
  , "  heap_rel_ptr ::"
  , "  \"(funtyp, abstyp, ptrtyp, ctyp) store \\<Rightarrow> lifted_globals \\<Rightarrow>"
  ...
  , "     typ_name_itself TYPE('a) = tyC \\<longrightarrow>"
  ...
  , ""
  , "definition state_rel :: \"((funtyp, abstyp, ptrtyp, ctyp) store \\<times> lifted_globals) set\""
  , "where"
